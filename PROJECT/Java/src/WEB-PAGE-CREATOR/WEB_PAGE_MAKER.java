...
* This is a software made by GTECH and is used to make different web pages quickly by giving the names of the files simply. It can create HTML, JSP and PHP based web pages all of them have four different parts to generate blank, simple, compound and complex web pages.
...
public class WEB_PAGE_MAKER{
    ...
    public class HyperTextMarkupLanguage{
        ...
        @TAG
        private void SHOW() throws java.io.IOException{
            ...
            } else if (GENERATE.equalsIgnoreCase("SIMPLE")){
            ...
            } else if (GENERATE.equalsIgnoreCase("COMPOUND")){
            ...
            } else if (GENERATE.equalsIgnoreCase("COMPLEX")){
    ...
    @TAG
    public class JavaServletPage{

        @TAG
        private class BLANK{

            String JSP_FILE_NAME, CSS_FILE_NAME, JSON_FILE_NAME, JS_FILE_NAME;
            ...
            @TAG
            public void JSP() throws java.io.IOException{

                System.out.print("Enter JSP file name : ");
                JSP_FILE_NAME = in.nextLine();

                java.io.PrintWriter write = new java.io.PrintWriter(JSP_FILE_NAME + ".jsp");
        ...
        private class COMPOUND{
            ...
            String JSP_FILE_NAME1, JSP_FILE_NAME2, JSP_FILE_NAME3 , CSS_FILE_NAME, JSON_FILE_NAME, JS_FILE_NAME;
            ...
            public void JSP() throws java.io.IOException{
                ...
                System.out.print("Enter index JSP file name : ");
                JSP_FILE_NAME1 = in.nextLine();
                java.io.PrintWriter write1 = new java.io.PrintWriter(JSP_FILE_NAME1 + ".jsp");

                System.out.print("Enter about JSP file name : ");
                JSP_FILE_NAME2 = in.nextLine();
                java.io.PrintWriter write2 = new java.io.PrintWriter(JSP_FILE_NAME2 + ".jsp");

                System.out.print("Enter login JSP file name : ");
                JSP_FILE_NAME3 = in.nextLine();
                java.io.PrintWriter write3 = new java.io.PrintWriter(JSP_FILE_NAME3 + ".jsp");
                ...
                write3.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME1 + ".jsp\" class=\"hover\">");
                write3.println("""
                                    <div class=\"_buttons\">HOME</div>
                                </a>
                """);

                write3.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME2 + ".jsp\" class=\"hover\">");
                write3.println("""
                                    <div class=\"_buttons\">ABOUT</div>
                                </a>
                """);

                write3.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME3 + ".jsp\" class=\"hover\">");
                write3.println("""
                                    <div class=\"_buttons\">LOGIN</div>
                                </a>
                            </div>
                ...
                write2.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME1 + ".jsp\" class=\"hover\">");
                write2.println("""
                                    <div class=\"_buttons\">HOME</div>
                                </a>
                """);

                write2.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME2 + ".jsp\" class=\"hover\">");
                write2.println("""
                                    <div class=\"_buttons\">ABOUT</div>
                                </a>
                """);

                write2.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME3 + ".jsp\" class=\"hover\">");
                write2.println("""
                                    <div class=\"_buttons\">LOGIN</div>
                                </a>
                            </div>
                ...
                write1.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME1 + ".jsp\" class=\"hover\">");
                write1.println("""
                                    <div class=\"_buttons\">HOME</div>
                                </a>
                """);
                
                write1.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME2 + ".jsp\" class=\"hover\">");
                write1.println("""
                                    <div class=\"_buttons\">ABOUT</div>
                                </a>
                """);

                write1.println("\t\t\t\t<a href=\"./" + JSP_FILE_NAME3 + ".jsp\" class=\"hover\">");
                write1.println("""
                                    <div class=\"_buttons\">LOGIN</div>
                                </a>
                            </div>
    ...
    public class PHP{
        ...
        private class BLANK{
            ...
            String PHP_FILE_NAME, CSS_FILE_NAME, JSON_FILE_NAME, JS_FILE_NAME;
            ...
            @TAG
            public void PHP() throws java.io.IOException{

                System.out.print("Enter PHP file name : ");
                PHP_FILE_NAME = in.nextLine();

                java.io.PrintWriter write = new java.io.PrintWriter(PHP_FILE_NAME + ".php");
        ...
        private class COMPOUND{
            ...
            String PHP_FILE_NAME1, PHP_FILE_NAME2, PHP_FILE_NAME3 , CSS_FILE_NAME, JSON_FILE_NAME, JS_FILE_NAME;
            ...
            public void PHP() throws java.io.IOException{
                ...
                System.out.print("Enter index PHP file name : ");
                PHP_FILE_NAME1 = in.nextLine();
                java.io.PrintWriter write1 = new java.io.PrintWriter(PHP_FILE_NAME1 + ".php");

                System.out.print("Enter about PHP file name : ");
                PHP_FILE_NAME2 = in.nextLine();
                java.io.PrintWriter write2 = new java.io.PrintWriter(PHP_FILE_NAME2 + ".php");

                System.out.print("Enter login PHP file name : ");
                PHP_FILE_NAME3 = in.nextLine();
                java.io.PrintWriter write3 = new java.io.PrintWriter(PHP_FILE_NAME3 + ".php");
                ...
                write3.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME1 + ".php\\\" class=\\\"hover\\\">");
                write3.println("""
                                    <div class=\\\"_buttons\\\">HOME</div>
                                </a>
                """);

                write3.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME2 + ".php\\\" class=\\\"hover\\\">");
                write3.println("""
                                    <div class=\\\"_buttons\\\">ABOUT</div>
                                </a>
                """);

                write3.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME3 + ".php\\\" class=\\\"hover\\\">");
                write3.println("""
                                    <div class=\\\"_buttons\\\">LOGIN</div>
                                </a>
                            </div>
                ...
                write2.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME1 + ".php\\\" class=\\\"hover\\\">");
                write2.println("""
                                    <div class=\\\"_buttons\\\">HOME</div>
                                </a>
                """);

                write2.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME2 + ".php\\\" class=\\\"hover\\\">");
                write2.println("""
                                    <div class=\\\"_buttons\\\">ABOUT</div>
                                </a>
                """);

                write2.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME3 + ".php\\\" class=\\\"hover\\\">");
                write2.println("""
                                    <div class=\\\"_buttons\\\">LOGIN</div>
                                </a>
                            </div>
                ...
                write1.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME1 + ".php\\\" class=\\\"hover\\\">");
                write1.println("""
                                    <div class=\\\"_buttons\\\">HOME</div>
                                </a>
                """);
                
                write1.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME2 + ".php\\\" class=\\\"hover\\\">");
                write1.println("""
                                    <div class=\\\"_buttons\\\">ABOUT</div>
                                </a>
                """);

                write1.println("\t\t\t\t<a href=\\\"./" + PHP_FILE_NAME3 + ".php\\\" class=\\\"hover\\\">");
                write1.println("""
                                    <div class=\\\"_buttons\\\">LOGIN</div>
                                </a>
                            </div>
    ...
    private void START() throws java.io.IOException{
        ...
        System.out.println("""
            ...
            Enter HTML to generate HTML based web pages.
            Enter JSP to generate Java based web pages.
            Enter PHP to generate PHP based web pages.
            """);
        ...
        if(choice.equalsIgnoreCase("HTML")){
            ...
            HyperTextMarkupLanguage ob = new HyperTextMarkupLanguage();
            ob.main();

        } else if(choice.equalsIgnoreCase("JSP")){

            JavaServletPage ob = new JavaServletPage();
            ob.main();
    ...
    public static void main(String... DONE) throws java.io.IOException{

        WEB_PAGE_MAKER object = new WEB_PAGE_MAKER();
        object.START();
