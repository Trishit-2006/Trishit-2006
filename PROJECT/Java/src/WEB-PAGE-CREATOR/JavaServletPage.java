...
public class JavaServletPage{
    ...
    private static class BLANK{
        ...
        public void JSP() throws java.io.IOException{
            ...
            java.io.PrintWriter write = new java.io.PrintWriter(HTML_FILE_NAME + ".jsp");
    ...
    private static class COMPOUND{
        ...
        public void JSP() throws java.io.IOException{
            ...
            java.io.PrintWriter write1 = new java.io.PrintWriter(HTML_FILE_NAME1 + ".jsp");

            System.out.print("Enter about HTML file name : ");
            HTML_FILE_NAME2 = in.nextLine();
            java.io.PrintWriter write2 = new java.io.PrintWriter(HTML_FILE_NAME2 + ".jsp");

            System.out.print("Enter login HTML file name : ");
            HTML_FILE_NAME3 = in.nextLine();
            java.io.PrintWriter write3 = new java.io.PrintWriter(HTML_FILE_NAME3 + ".jsp");
            ...
            write3.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME1 + ".jsp\" class=\"hover\">");
            write3.println("""
                                <div class=\"_buttons\">HOME</div>
                            </a>
            """);

            write3.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME2 + ".jsp\" class=\"hover\">");
            write3.println("""
                                <div class=\"_buttons\">ABOUT</div>
                            </a>
            """);

            write3.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME3 + ".jsp\" class=\"hover\">");
            write3.println("""
            ...
            write2.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME1 + ".jsp\" class=\"hover\">");
            write2.println("""
                                <div class=\"_buttons\">HOME</div>
                            </a>
            """);

            write2.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME2 + ".jsp\" class=\"hover\">");
            write2.println("""
                                <div class=\"_buttons\">ABOUT</div>
                            </a>
            """);

            write2.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME3 + ".jsp\" class=\"hover\">");
            write2.println("""
                                <div class=\"_buttons\">LOGIN</div>
                            </a>
                        </div>
            ...
            write1.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME1 + ".jsp\" class=\"hover\">");
            write1.println("""
                                <div class=\"_buttons\">HOME</div>
                            </a>
            """);
            
            write1.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME2 + ".jsp\" class=\"hover\">");
            write1.println("""
                                <div class=\"_buttons\">ABOUT</div>
                            </a>
            """);

            write1.println("\t\t\t\t<a href=\"./" + HTML_FILE_NAME3 + ".jsp\" class=\"hover\">");
            write1.println("""
                                <div class=\"_buttons\">LOGIN</div>
                            </a>
                        </div>
